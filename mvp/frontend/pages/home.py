...
#     #     try:
#     #         response = requests.get("http://127.0.0.1:8000/api/v1/endpoints/test/")
#     #         if response.status_code == 200:
...
#                 if response.status_code == 200:
#                     recognized_text = response.json().get("text", "No text found")
...
#                     if response.status_code == 200:
#                         recognized_text = response.json().get("translated_text", "Translation failed")
...
#             try:
#                 response = requests.post(NER_API_URL, json={"text": recognized_text})
#                 if response.status_code == 200:
